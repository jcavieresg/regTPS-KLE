...
regTPS_KLE <- function(sp_data, dim_grid, n_basis_app = 0.95, 
  ...
  cat("  Using standard eigenvalue problem (S psi = v psi)\n")
  ...
  lambda_k[1:M_P_null_space] <- 1.0  # Null space
  ...
  tmb_data <- list(
    ...
    logalpha_prior_mean = 0.0,
    logalpha_prior_sd = 0.75)
...
# Rest of your application code is correct as-is
