...
#        # y = "log(Comp. efficiency)",
#        y = "log(Median Bulk ESS / min)", 
#        title="Computational Efficiency (Exponential)") +
...
#   Efficiency = c(
#     eff_spde_bulk_mat1, eff_spde_bulk_mat2, eff_spde_bulk_mat3, eff_spde_bulk_mat4,
#     eff_tps_bulk_mat1, eff_tps_bulk_mat2, eff_tps_bulk_mat3, eff_tps_bulk_mat4,
...
p_comp_eff <- ggplot(
  ...
  labs(
    x = "Scenarios",
    y = expression(log(Median~Bulk~ESS/min)),
    title = "Computational Efficiency Comparison"
  ) +
  theme(
